...
| 报表集市 | Embedded dashboards | /tracking-web/iframe/* + shareDashboard iframe | 可读部分报表 | 2026-08-03 | 70 个报表条目、运营周报、TC、游戏、增长和经济指标 | 部分默认 `No Data`；BQ/非 BQ 差异未知 | 否 | 仅人工复核；不改外部报表 |
