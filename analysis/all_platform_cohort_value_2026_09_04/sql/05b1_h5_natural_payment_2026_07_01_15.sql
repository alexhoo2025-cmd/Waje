-- Aggregate-only July 1-15 strict H5 natural payment lifecycle; success orders only.
WITH cohort AS (
  ...
  WHERE target_day BETWEEN DATE '2026-07-01' AND DATE '2026-07-28'
...
FROM lifecycle
WHERE cohort_date BETWEEN DATE '2026-07-01' AND DATE '2026-07-15'
