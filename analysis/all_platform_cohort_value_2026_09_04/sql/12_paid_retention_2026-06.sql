...
WITH profile_versions AS (
 ...
 SELECT target_day AS payment_date, user_id
 ...
 WHERE p.p.register_date BETWEEN DATE '2026-06-01' AND DATE '2026-06-30'
 UNION ALL
 ...
 WHERE p.p.first_pay_date BETWEEN DATE '2026-06-01' AND DATE '2026-06-30'
), cohorts AS (
...
SELECT '2026-06' AS cohort_month,payer_group,platform,output_package_name AS package_name,output_channel AS channel,breakdown,day_number,
