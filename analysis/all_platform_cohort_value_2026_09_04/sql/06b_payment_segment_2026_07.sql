-- Aggregate-only July payer lifecycle segmentation by first package and channel.
...
SELECT
  ...
  COUNTIF(register_date BETWEEN DATE '2026-07-01' AND DATE '2026-07-31') AS unique_new_registered_payers,
  COUNTIF(has_first_payment) AS unique_first_payers,
  COUNTIF(first_pay_date < DATE '2026-07-01') AS unique_old_payers_at_period_start,
