-- Aggregate-only August payer lifecycle segmentation by first package and channel.
...
SELECT
  ...
  COUNTIF(first_pay_date < DATE '2026-08-01') AS unique_old_payers_at_period_start,
