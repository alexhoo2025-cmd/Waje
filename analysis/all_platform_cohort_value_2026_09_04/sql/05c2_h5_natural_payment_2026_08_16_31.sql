-- Aggregate-only August 16-31 strict H5 natural payment lifecycle; success orders only.
WITH cohort AS (
  SELECT DISTINCT target_day AS cohort_date, user_id
  FROM `wajenigeria.origin_hfyl.user_events`
  WHERE target_day BETWEEN DATE '2026-08-16' AND DATE '2026-08-31'
  ...
  WHERE target_day BETWEEN DATE '2026-08-16' AND DATE '2026-09-04'
