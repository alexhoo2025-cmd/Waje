-- Aggregate-only July 16-31 strict H5 natural payment lifecycle; success orders only.
WITH cohort AS (
  ...
  WHERE target_day BETWEEN DATE '2026-07-16' AND DATE '2026-08-13'
...
FROM lifecycle
WHERE cohort_date BETWEEN DATE '2026-07-16' AND DATE '2026-07-31'
