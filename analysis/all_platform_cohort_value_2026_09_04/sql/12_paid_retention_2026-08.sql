...
WITH profile_versions AS (
 ...
 WHERE p.p.first_pay_date BETWEEN DATE '2026-08-01' AND DATE '2026-08-31'
), cohorts AS (
 ...
 WHERE target_day BETWEEN DATE '2026-08-01' AND DATE '2026-09-03'
...
SELECT '2026-08' AS cohort_month,payer_group,platform,output_package_name AS package_name,output_channel AS channel,breakdown,day_number,
