...
WITH raw_orders AS (
  ...
  FROM raw_orders
  WHERE cohort_date BETWEEN DATE '2026-09-01' AND DATE '2026-09-02'
...
SELECT
  ...
  COUNTIF(register_date BETWEEN DATE '2026-09-01' AND DATE '2026-09-02') AS unique_new_registered_payers,
