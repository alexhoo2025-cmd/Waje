WITH events AS (
 ...
 WHERE target_day BETWEEN DATE '2026-08-01' AND DATE '2026-08-19' AND app_id=90006 AND event_type='GAMEEND'
), labelled AS (
 ...
 FROM events WHERE stat_date BETWEEN DATE '2026-08-01' AND DATE '2026-08-19'
