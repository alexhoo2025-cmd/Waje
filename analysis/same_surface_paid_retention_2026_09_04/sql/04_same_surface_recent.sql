...
WITH s AS (
 ...
 WHERE target_day BETWEEN DATE '2026-09-01' AND DATE '2026-09-03' AND app_id=90006
...
SELECT payer_group,cohort_date,origin_surface,anchor_client,day_number,
...
GROUP BY payer_group,cohort_date,origin_surface,anchor_client,day_number
HAVING COUNT(*)>=10
ORDER BY payer_group,cohort_date,anchor_client,day_number
LIMIT 3000;
