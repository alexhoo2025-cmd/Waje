-- Compact H5 Analytics window summary. Keep the four observed standard event
-- names because they are the current H5 behavior dictionary; no raw rows.
SELECT
  'h5' AS endpoint,
...
GROUP BY endpoint, app_package, app_version, event_category, event_name_bucket
