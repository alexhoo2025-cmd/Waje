...
**当前状态：`quality_warning`。** At least one dimension result reached the 3000-row output cap
...
| query_limit:native_performance_dimensions | `quality_warning` | result reached the 3000-row output cap; refine the dimension or date slice for a complete ranking |
| query:crashlytics_stability_daily | `ok` |  |
| query_limit:crashlytics_stability_daily | `quality_warning` | result reached the 3000-row output cap; refine the dimension or date slice for a complete ranking |
