WITH profile_scope AS (
  ...
  WHERE o.app_id = 90006
    AND o.target_day BETWEEN DATE '2026-07-14' AND DATE '2026-07-28'
  ...
  WHERE app_id = 90006
    AND target_day BETWEEN DATE '2026-07-07' AND DATE '2026-08-04'
...
SELECT
  'post_2026-07-14_to_07-28' AS period,
  path_group,
