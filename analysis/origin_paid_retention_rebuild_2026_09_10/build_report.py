...
- **新增付费：** 8月按起源口径纳入新增、且在新增当日完成首次付费的用户。
- **全部新增：** 8月按起源口径统计的全部新增用户，包括付费和未付费用户，不等同于新增注册用户。
- **首次付费：** 8月完成历史首次成功付费的用户，包括此前已注册的用户；以首次付费日为统计起点。
- **回访：** 同一批用户在指定观察日再次活跃，允许跨端回访，不要求再次付费。起点日为第1日，次留为第2日，第7日和第15日按相应自然日统计。
- **达标范围：** 次日与第7日覆盖8月全月；第15日覆盖8月1—26日，第30日覆盖8月1—11日。第60日未达到统计口径，第90日不纳入本报告。
